...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;企业端后台',
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => App\Company\Controllers\AuthController::class,
    ...
    */
    'database' => [
        ...
        'users_table' => 'company_admin_users',
        'users_model' => App\Models\CompanyAdminUser::class,

        // Role table and model.
        'roles_table' => 'company_admin_roles',
        'roles_model' => Dcat\Admin\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'company_admin_permissions',
        'permissions_model' => Dcat\Admin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'company_admin_menu',
        'menu_model' => Dcat\Admin\Models\Menu::class,

        // Pivot table for table above.
        'role_users_table'       => 'company_admin_role_users',
        'role_permissions_table' => 'company_admin_role_permissions',
        'role_menu_table'        => 'company_admin_role_menu',
        'permission_menu_table'  => 'company_admin_permission_menu',
        'settings_table'         => 'company_admin_settings',
		'extensions_table'       => 'company_admin_extensions',
		'extension_histories_table' => 'company_admin_extension_histories',
    ],
