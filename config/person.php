...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;个人后台',
    ...
    */
    'route' => [
        ...
        'namespace' => 'App\\Person\\Controllers',
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => App\Person\Controllers\AuthController::class,
        ...
        'providers' => [
            'person' => [
                'driver' => 'eloquent',
                'model'  => App\Models\PersonAdminUser::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_table' => 'person_admin_users',
        'users_model' => App\Models\PersonAdminUser::class,

        // Role table and model.
        'roles_table' => 'person_admin_roles',
        'roles_model' => Dcat\Admin\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'person_admin_permissions',
        'permissions_model' => Dcat\Admin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'person_admin_menu',
        'menu_model' => Dcat\Admin\Models\Menu::class,

        // Pivot table for table above.
        'role_users_table'       => 'person_admin_role_users',
        'role_permissions_table' => 'person_admin_role_permissions',
        'role_menu_table'        => 'person_admin_role_menu',
        'permission_menu_table'  => 'person_admin_permission_menu',
        'settings_table'         => 'person_admin_settings',
		'extensions_table'       => 'person_admin_extensions',
		'extension_histories_table' => 'person_admin_extension_histories',
    ],
